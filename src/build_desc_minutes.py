"""Booking/substitution descriptives over the 90 minutes.

Computes headline stats (cards & subs per match, half
...
Outputs: figures/fig_timing_cards.png, figures/fig_timing_subs.png (each a 2x2 grid:
...
def main():
    ...
    for d in (yel, sub):
        ...
        d["grp"] = d.position.map(POSITION_GROUP)
